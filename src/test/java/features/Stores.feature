...
@Stores
#Feature level tag .will run for each scenario
Feature: Scenario for Stores API
#Background wil run before each scenario

Background: Create s tore and save its store id
